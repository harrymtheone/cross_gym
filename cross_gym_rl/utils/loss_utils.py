...
def masked_mean(tensor: torch.Tensor, mask: torch.Tensor | slice) -> torch.Tensor:
...
def masked_sum(tensor: torch.Tensor, mask: torch.Tensor | slice) -> torch.Tensor:
...
def masked_MSE(pred: torch.Tensor, target: torch.Tensor, mask: torch.Tensor | slice) -> torch.Tensor:
...
def masked_L1(pred: torch.Tensor, target: torch.Tensor, mask: torch.Tensor | slice) -> torch.Tensor:
