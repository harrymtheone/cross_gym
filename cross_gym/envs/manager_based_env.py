...
class ManagerBasedEnv:
    ...
    def __init__(self, cfg: ManagerBasedEnvCfg):
        ...
        if SimulationContext.instance() is None:
            ...
            if self.cfg.sim.simulator.name == "ISAACGYM":
                from cross_gym.sim.isaacgym import IsaacGymContext
                self.sim: SimulationContext = IsaacGymContext(self.cfg.sim)
            elif self.cfg.sim.simulator.name == "GENESIS":
                # TODO: Implement Genesis
                raise NotImplementedError("Genesis simulator not yet implemented")
            elif self.cfg.sim.simulator.name == "ISAACSIM":
                # TODO: Implement IsaacSim
                raise NotImplementedError("IsaacSim simulator not yet implemented")
            else:
                raise ValueError(f"Unknown simulator: {self.cfg.sim.simulator}")
        else:
