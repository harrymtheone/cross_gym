...
from bridge_rl.utils.logger import Logger, EpisodeLogger
...
class OnPolicyRunner:
    ...
    def __init__(self, cfg: OnPolicyRunnerCfg):
        """Initialize runner.
        ...
        self.env: ManagerBasedRLEnv = cfg.env_cfg.class_type(cfg.env_cfg)
        print(f"[INFO] Environment created: {self.env.num_envs} parallel environments")
        
        # Create algorithm
        print(f"[INFO] Creating algorithm: {cfg.algorithm_cfg.class_type.__name__}")
        self.algorithm = cfg.algorithm_cfg.class_type(cfg.algorithm_cfg, self.env)
        print("[INFO] Algorithm created")
